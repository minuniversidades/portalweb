---
title: "Especialidad: Enfermería de Cuidados Médico-Quirúrgicos"
section_img: "./images/people-ge0ac76f69_1920.jpeg"
weight: 4
---
## Especialidad: Enfermería de Cuidados Médico-Quirúrgicos<br><br>
<a href="https://sede.educacion.gob.es/sede/login/inicio.jjsp?idConvocatoria=823" target="_blank">Acceso al servicio online <i class="fas fa-external-link-alt"></i></a><br><br>
<b>PROCESO ABIERTO (PROGRAMA FORMATIVO AÚN NO APROBADO)</b>
<section>
    <article>
				...
				<div class="download_card"> 
					...
					<div class="card-body"> 
						...
						<span class="tit">Solicitud acceso excepcional título de enfermero especialista</span></a> <i class="fal fa-file-word text-primary"></i> DOC (107,037 KB)
								...
								<b>Nota importante:</b> El abono de tasas solo se puede efectuar tras haber recibido la notificación de la concesión del título oficial de especialista correspondiente.
								<div class="col-lg-12 cards_download_cnt">  
								<div class="col-12 box_card_title d-flex"> 
			<h3 class="title_separador"><i class="fas fa-download"></i>Información relacionada</h3> 
	</div> 
