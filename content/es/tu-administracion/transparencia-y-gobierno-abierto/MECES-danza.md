...
struc_dep_pic: ""
---
## Procedimiento de correspondencia a nivel MECES del título superior de Danza en todas sus especialidades<br><br>
<section>
    <article>
        <div class="container container_xl_accoordion p-0">
            <div class="row mt-4">
                <div class="col-lg-12 content_collapse mb-120">
								...
								Acordado su inicio, en lo que se refiere al <b>Título Superior de Danza en todas sus especialidades, </b>declarado equivalente, a todos los efectos, al título de Licenciado Universitario, y evacuados los informes preceptivos de la Agencia Nacional de Evaluación de la Calidad y Acreditación y del Consejo de Universidades, previstos en el artículo 21 del citado real decreto, procede en este momento el inicio del período de información pública establecido en su artículo 23. <br><br>
			...
			<div class="row"> 
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}documentos/pdf/tu_administracion/pdf-no-reglametario/Acuerdo_inicio_Danza_Firmado.pdf" target="_blank"> 
				...
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}documentos/pdf/tu_administracion/pdf-no-reglametario/200903_IC-EEAA-ANECA_Titulo_Superior_Danza_Firmado.pdf" target="_blank"> 
					<div class="card-header"> 
						   <i class="fal fa-download"></i> 
					</div> </a> 
					<div class="card-body"> 
				...
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}documentos/pdf/tu_administracion/pdf-no-reglametario/Informe_CU_Danza_firmado.pdf" target="_blank"> 
					<div class="card-header"> 
						   <i class="fal fa-download"></i> 
					</div> </a> 
					<div class="card-body"> 
				...
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}documentos/pdf/tu_administracion/pdf-no-reglametario/BOE_B_2021_4080.pdf" target="_blank"> 
					<div class="card-header"> 
						   <i class="fal fa-download"></i> 
					</div> </a> 
					<div class="card-body"> 
						...
						<span class="tit">Acuerdo de información pública (BOE)</span></a> <i class="fal fa-file-pdf pdf_icon"></i> (PDF 166,975 KB)
								...
								<ul>
									<li>ASUNTO CORREO: Observaciones MECES título superior de Danza en todas sus especialidades.</li>
